...
/**
 * Class custom piece two
 */
public class Custom_Piece_Two extends Pieces {


    /** Combine Kight and Bishop */
    public Custom_Piece_Two(char y, int x, boolean c){
        this.positionY = y;
        this.positionX = x;
        this.color = c;
    ...
    /** Find the possible move position of the Knight and Bishop
    ...
    public ArrayList get_move_positions(){
        ...
        if(player1.get_turn()){
            ...
            for(int i = 1; i < 5; i++) {
                calculate_positions_di(i, curr_x, curr_y, this.possible_m, p1_positions, p2_positions, true);
            }
            ...
            for(int i = 1; i < 5; i++) {
                calculate_positions_di(i, curr_x, curr_y, this.possible_m, p1_positions, p2_positions, false);
            }
    ...
    /** Calculate for the diagonal moving position of piece
     ...
     *
     * */
    private void calculate_positions_di(int pos, int x, char y, ArrayList added, ArrayList p1, ArrayList p2, boolean player){
        int block0 =0;
        int block1 = 0;
        for(int i = 1; i<8; i++){
            char p = y; // curr_y
